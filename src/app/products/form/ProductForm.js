...
export default function ProductForm({ show, toggle}) {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <TextFormField  label="Discount"
                                                    ...
                                                    disabled={true}
                                                    value={
                                                        "Ush " + (formProps.values.globalPrice - formProps.values.price).toLocaleString() +
                                                        " or "
                                                        + (((formProps.values.globalPrice - formProps.values.price)/(formProps.values.globalPrice)) * 100).toFixed(1) + "%"
                                                         }
                                                    error={formProps.touched.price && formProps.errors.price}/>
                                </div>
                                ...
                                <div>
                                    <TextFormField label="Stock Count"
                                                name="stockCount"
                                                placeHolder="Enter quanity in stock"
                                                onChange={formProps.handleChange}
                                                onBlur={formProps.handleBlur}
